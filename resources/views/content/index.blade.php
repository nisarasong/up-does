...
<div class="main-content">
    <h2><i class="far fa-list-alt"></i>  จัดการข่าวสาร
        <div class="btn-group pull-right">
            <a href="{{action('NewsController@index')}}"><button type="button" class="btn btn-primary"><i class="fas fa-plus-square"></i> เพิ่มข่าวสาร</button></a>
        </div>
    </h2>
    <hr>
    <?php
    ...
    <form action="{{url('/content')}}" method="get">
    ...
    <div class="table-responsive" style="height:100vh;">
        <table id="example" class="display table table-striped" cellspacing="0">
            <thead>
                <tr>
                    <th>@sortablelink('orders','ลำดับ')</th>
                    <th>@sortablelink('title_th','หัวข้อภาษาไทย')</th>
                    <th>@sortablelink('title_en','หัวข้อภาษาอังกฤษ')</th>
                    <th>@sortablelink('type','ชนิด')</th>
                    <th>@sortablelink('last_user_new','ผู้ใช้ล่าสุด')</th>
                    <th>แก้ไขล่าสุด</th>
                    <th>แก้ไข</th>
                    <th>ลบ</th>
                </tr>
