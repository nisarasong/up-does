    ...
    <div class="table-responsive">
        <table id="example" class="display table table-striped" cellspacing="0">
            <thead>
                <tr>
                    <th>#</th>
                    <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('orders','ลำดับสไลด์'));?></th>
                    <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('id','สไลด์'));?></th>
                    <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('url','ลิ้งค์'));?></th>
                    <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('des','แสดง'));?></th>
                    <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('create_user','สร้างโดย'));?></th>
                    <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('create_date','วันที่สร้าง'));?></th>
                    <th>แก้ไข</th>
                    <th>ลบ</th>
                </tr>
            </thead>
...
<div class="modal fade" id="addsl" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo e(action('SlideController@savePH')); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?php echo e(action('SlideController@update')); ?>" method="post">
                    <?php echo e(csrf_field()); ?>
