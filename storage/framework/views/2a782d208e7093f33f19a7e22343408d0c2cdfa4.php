...
<div class="main-content">
    ...
    <hr>
    <form action="<?php echo e(url('/galleryM')); ?>" method="get">
    ...
    <div class="table-responsive">
        <table id="example" class="display table table-striped" cellspacing="0" style="font-size:16px; ">
            <thead>
                <tr>
                    <th>#</th>
                    <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('gid','อัลบั้ม'));?></th>
                    <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('g_name_th','ชื่ออัลบั้ม'));?></th>
                    <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('last_user','แก้ไขโดย'));?></th>
                    <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('create_date','แก้ไขล่าสุด'));?></th>
                    <th>แก้ไข</th>
                    <th>รูปภาพ</th>
                    <th>ลบ</th>
                </tr>
            ...
            <tbody>
                ...
                foreach ($gallery as $gallerys) {
                    echo '<tr>
                            <td>' . $i++ . '</td>
                            <td><img class="zoom" style="height:150px; width:250px; border: 3px solid #3cc3d8;   " src="' . $media_manage->viewIndexImageByID($gallerys->gid) . '"/></td>
                            <td><p >' . $gallerys->g_name_th . '</p></td>
                            <td>' . $gallerys->last_user . '</td>
                            <td>' . $db->convertDate($gallerys->create_date) . '</td>
                            <td><a data-toggle="modal" data-target="#myModal" data-img="' . $media_manage->viewIndexImageByID($gallerys->gid) . '" data-id="' . $gallerys->gid . '" data-name="' . $gallerys->g_name_th . '" class="btn btn-warning"><i class="far fa-edit"></i> แก้ไข</a></td>
    ...
    <?php echo $gallery->appends(\Request::except('page'))->render(); ?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?php echo e(action('Controller@update')); ?>" method="post">
            ...
            <form action="<?php echo e(action('Controller@insert_gal')); ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text"  value="gallery<?php echo e(date("Y-m-d h:m:s")); ?>" placeholder="ชื่อภาษาอังกฤษ" id="g_name_en" name="g_name_en" required/>
                    </div>
                    <div class="form-group">
