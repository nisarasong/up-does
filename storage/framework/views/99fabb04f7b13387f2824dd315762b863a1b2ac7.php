...
<html lang="<?php echo e(app()->getLocale()); ?>">
    ...
    <body>
        ...
        <div class="container align-center">
            <div class="row justify-content-md-center">
                <div class="mbr-white col-md-10">
                    <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-2"><?php echo e(__("does")); ?></h1>
                    <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-4"><?php echo e(__("up")); ?></h1><hr>
                    <p class="mbr-text pb-3 mbr-fonts-style display-5"><strong>
                            " <?php echo e(__("slogan1")); ?> "
                        </strong></p>
        ...
        <div class="container">
            <div class="media-container-row">
                <div class="title col-12 col-md-8">
                    ...
                    <h3 class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5"><?php echo e(__("th")); ?>:
                        <div><strong>กบศ. (กองบริการการศึกษา)&nbsp;</strong></div><br><div><?php echo e(__("eng")); ?>:<strong>
        ...
        <div class="media-container-row">
            <div class="mbr-text col-12 col-md-8 mbr-fonts-style display-5"><strong><?php echo e(__("slogan")); ?>

                </strong><div><strong>" <?php echo e(__("slogan1")); ?> "</strong></div></div>
        </div>
    </div>
    <?php $blog->blogOffC(); ?>
