...
<div class="main-content">
    ...
    <table id="example" class="display table table-striped" cellspacing="0" style="font-size:16px; ">
        <thead>
            <tr>
                <th>#</th>
                <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('type_news_cat','ประเภทข่าว'));?></th>
                <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('name_th','หัวข้อภาษาไทย'));?></th>
                <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('name_en','หัวข้อภาษาอังกฤษ'));?></th>
                <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('last_user','ผู้ใช้ล่าสุด'));?></th>
